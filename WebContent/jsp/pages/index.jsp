...
<head>
    ...
    <meta name="author" content="Pijus Kumar Sarker">
...
<body>
    ...
    <script src="../CrudApp/jsp/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="../CrudApp/jsp/bower_components/metisMenu/dist/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="../CrudApp/jsp/bower_components/raphael/raphael-min.js"></script>
    <script src="../CrudApp/jsp/bower_components/morrisjs/morris.min.js"></script>
    <script src="../CrudApp/jsp/js/morris-data.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="../CrudApp/jsp/dist/js/sb-admin-2.js"></script>
